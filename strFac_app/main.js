...
// Global variables to store parsed CIF data
let currentParsedCifData = null;
let debounceTimeoutForCamera = null; // For debouncing camera rotation updates
...
function handleFileSelection(event) {
  ...
  reader.onload = () => {
    ...
    // Initial plotting using the default or current plane input value
